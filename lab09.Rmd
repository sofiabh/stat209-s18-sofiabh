...
ggplot(trump, aes(date, approve)) +
  ...
  geom_point(aes(color=approve), size=2) +
  geom_point(aes(y=disapprove)) +
  annotate("text", x=as.Date("2017-02-07"), y=46.9, label="Highest Approval")
```

In this dataset, I found the differences in Trump's approval ratings from April 2017 to January 2018.  I created a text annotation noting Trump's highest approval rating, which was 46.9% in early 2017.
