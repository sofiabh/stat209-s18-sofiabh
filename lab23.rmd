...
**Answer**: Because 1 is true and 0 is false, a mean of only 0.172 suggests that the majority of crimes did not result in an arrest; so only about 17% of crimes led to an arrest.
...
**Answer**: Only about 20% of crimes were thefts.
...
**Answer**: Of all of the crimes in the dataset, 38816 were thefts.
...
**Answer**: It is larger, and we can compare them in that about 25% of crimes in Humboldt Park resulted in arrests while for the area at large, only 17% of crimes resulted in arrests.
...
**Answer**: It is smaller, with about 18% of crimes in Humboldt Park being thefts versus about 27% of crimes in the area as a whole resulting in thefts.
...
**Answer**: It is larger, with about 44 thefts per 1000 households in Humboldt Park as opposed to about 36 thefts per 1000 households in the area as a whole.
...
**Answer**: There isn't much a correlation between theft rate and income level, but there are a few outliers.  One of the highest income levels has an outlier of an extremely high theft rate.
...
**Answer**: One of the reasons is that it is one of the biggest business districts in the country, and the other is that it is really populated and so theft is very common, but there are very few households because it is not a residential area. So while it is a big business/shopping/tourism district but not a big residential neighborhood, the proportion of thefts per household isn't aligned with the rest of neighborhoods on the plot.
